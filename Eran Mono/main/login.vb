Public Class login
    ...
    Sub connecting()
        ...
        If ini.GetKeyValue("account", "alias").Length > 0 Then
            EranAPI.Account.Aliasname = ini.GetKeyValue("account", "alias")
        Else
            EranAPI.Account.Aliasname = username_txt.Text
        End If

        EranAPI.Account.AuthKey = ini.GetKeyValue("account", "authkey")
        EranAPI.Account.OnlineState = 2
